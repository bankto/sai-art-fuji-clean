...
最終更新: 2026-07-11（AR検証・M3.5を保留）

## 現在のフェーズ

**Phase 5: 実装**(1件目デモ: ソフトウェア完了・レビューShould反映済み / M1〜M2.5の実機確認待ち / AR・M3.5は保留)
...
- [ ] 実機確認(M1〜M2.5): GitHub Pages HTTPS でカメラ・生成・URL/QR/NFC（ユーザー都合で後日）
