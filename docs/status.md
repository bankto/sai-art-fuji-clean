...
最終更新: 2026-07-10（カメラ認識 × AR ゴミデモ仕様書レビュー指摘反映完了）

## 現在のフェーズ

**Phase 4: 仕様書作成**(下書き作成済み・レビュー指摘反映済み)
...
| 4. 仕様書作成 | Cursor 指揮(Codex 作成 / Claude Code レビュー) | 進行中 | `docs/specs/2026-07-10_camera-ar-gomi-demo.md` + `docs/reviews/2026-07-10_camera-ar-gomi-demo_review.md` | レビュー=条件付き承認。Must 3件と対応可能なShould/Couldを仕様書へ反映済み。ユーザー確認(M2/M3範囲・NFC/QR主導)待ち |
| 5. 実装 | Cursor 指揮(Codex 実装 / Claude Code レビュー) | 未着手 | - | |
...
- [ ] ユーザー確認: M2までを完了範囲にするか、M3のAR/レーザー彫刻試作まで含めるか判断
- [ ] ユーザー確認: 持ち帰りをNFC主導 / QR主導 / 併設のどれにするか判断
...
| 2026-07-10 | 仕様書レビュー指摘を反映(使用AI / モデル / effort: Codex / 既定 / high) | Must 3件と対応可能なShould/Couldを反映。ステータスは下書きのまま。次はユーザー確認(M2/M3範囲・NFC/QR主導) |
